...
const cardData: cardDataType[] = [
  {
    imgSrc: '/images/_features/featureOne.svg',
    heading: 'Menu variations',
    subheading: 'Sed ut perspiciatis unde omnis iste natus error',
    link: 'Learn more',
  },
  {
    imgSrc: '/images/_features/featureTwo.svg',
    heading: 'Cooking warw',
    subheading: 'Sed ut perspiciatis unde omnis iste natus error',
    link: 'Learn more',
  },
  {
    imgSrc: '/images/_features/featureThree.svg',
    heading: 'Best chef',
    subheading: 'Sed ut perspiciatis unde omnis iste natus error',
    link: 'Learn more',
  },
  {
    imgSrc: '/images/_features/featureFour.svg',
    heading: 'Fast food',
    subheading: 'Sed ut perspiciatis unde omnis iste natus error',
    link: 'Learn more',
  },
